export function generateScaleXML(): string {
  return `<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE score-partwise PUBLIC "-//Recordare//DTD MusicXML 3.1 Partwise//EN" "http://www.musicxml.org/dtds/partwise.dtd">
<score-partwise version="3.1">
  <work>
    <work-title>C Major Scale (3 Octaves)</work-title>
  </work>
  <part-list>
    <score-part id="P1">
...
export function generateMelodyXML(): string {
  return `<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE score-partwise PUBLIC "-//Recordare//DTD MusicXML 3.1 Partwise//EN" "http://www.musicxml.org/dtds/partwise.dtd">
<score-partwise version="3.1">
  <work>
    <work-title>Simple Melody</work-title>
  </work>
  <part-list>
    <score-part id="P1">
...
export function generateTwinkleXML(): string {
  return `<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE score-partwise PUBLIC "-//Recordare//DTD MusicXML 3.1 Partwise//EN" "http://www.musicxml.org/dtds/partwise.dtd">
<score-partwise version="3.1">
  <work>
...
export function generateChordsXML(): string {
  return `<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE score-partwise PUBLIC "-//Recordare//DTD MusicXML 3.1 Partwise//EN" "http://www.musicxml.org/dtds/partwise.dtd">
<score-partwise version="3.1">
  <work>
    <work-title>Chord Progression (I-IV-V-I)</work-title>
  </work>
  <part-list>
    <score-part id="P1">
      <part-name>Piano</part-name>
  ...
  <part id="P1">
    ...
    <measure number="2">
      ...
      <note><chord/><pitch><step>C</step><octave>5</octave></pitch><duration>4</duration><type>whole</type></note>
    </measure>
    <measure number="3">
      <note><pitch><step>G</step><octave>4</octave></pitch><duration>4</duration><type>whole</type></note>
      <note><chord/><pitch><step>B</step><octave>4</octave></pitch><duration>4</duration><type>whole</type></note>
      <note><chord/><pitch><step>D</step><octave>5</octave></pitch><duration>4</duration><type>whole</type></note>
    </measure>
    <measure number="4">
      <note><pitch><step>C</step><octave>4</octave></pitch><duration>4</duration><type>whole</type></note>
      <note><chord/><pitch><step>E</step><octave>4</octave></pitch><duration>4</duration><type>whole</type></note>
...
export type DemoType = 'scale' | 'melody' | 'twinkle' | 'chords';

export function getDemoXML(type: DemoType): string {
  switch (type) {
    case 'scale':
      return generateScaleXML();
    case 'melody':
      return generateMelodyXML();
    case 'twinkle':
      return generateTwinkleXML();
    case 'chords':
      return generateChordsXML();
    default:
      return generateScaleXML();
  }
}
